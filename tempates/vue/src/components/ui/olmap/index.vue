<template>
  <adv-playground-page :scrollEl="scrollEl" ref="ref">
    <adv-playground-page-section title="OLMap">
      <p>对openlayers的封装</p>
      <ul>
        <li>- 提供GeoLayer</li>
        <li>- 提供TitleLayer</li>
  ...
  data() {
    return {
      ...
      `,
        ...
        {
          id: 'p2',
          name: '添加新北区的GeoJSONLayer',
          cardProps: {
            description: {
              title: '添加新北区的GeoJSONLayer',
        ...
        <script>
          export default {
            methods: {
              onCode1Fun1() {
                this.$refs.xbqRef.addMainGeoJSONLayer({
                  geoJSONStyle: {
                    stroke: {
          ...
          export default {
            methods: {
              onCode2Change1(e) {
                ...
                const tileLayer = this.$refs.changeRef.getMap().getLayers().item(0);
      ...
      `,
        ...
        <script>
          export default {
            methods: {
              onCode4Fun1() {
                const { /* vectorLayer, */ vectorSource } = this.$refs.fRef.addDataLayer();
      ...
      `,
        ...
        <script>
          export default {
            methods: {
              onCode5Fun1() {
                const { /* vectorLayer, */ vectorSource } = this.$refs.animationRef.addDataLayer();
                ...
                const ps =
                  Resource.Dict.value.ResourceGisXinbeiquGeoJSON.value.features[0].geometry.coordinates[0][0];
